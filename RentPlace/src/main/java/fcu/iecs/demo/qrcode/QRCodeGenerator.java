...
public class QRCodeGenerator {
    ...
    public static byte[] generateQRCodeFromString(String content, int width, int height) throws WriterException {
        try {
            ...
            try (ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream()) {
                ...
                return byteArrayOutputStream.toByteArray(); // 返回 QR Code 的字节数组
            }
        } catch (Exception e) {
